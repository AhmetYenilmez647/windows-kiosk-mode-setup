...
<#
.SYNOPSIS
    Windows Kiosk Modu Otomatik Kurulum Scripti (V2)
.DESCRIPTION
...
Write-Host "   WINDOWS KIOSK MODU KURULUM SCRIPTI (V2)" -ForegroundColor Magenta
Write-Host "==============================================" -ForegroundColor Magenta
Write-Host ""
...
.DESCRIPTION
    Setup-KioskMode V2 tarafindan yapilan tum degisiklikleri geri alir.
#>
...
Write-Host ""
Write-Host "==============================================" -ForegroundColor Magenta
Write-Host "   KURULUM TAMAMLANDI (V2)" -ForegroundColor Magenta
Write-Host "==============================================" -ForegroundColor Magenta
Write-Host ""
